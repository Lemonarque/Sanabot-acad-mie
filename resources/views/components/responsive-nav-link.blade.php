...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-emerald-400 text-start text-base font-semibold text-slate-900 bg-emerald-50 focus:outline-none transition duration-150 ease-in-out'
